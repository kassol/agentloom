...
Compatibility shortcuts:
  chub create <name> --cwd <path> [--runtime codex|pi] [--approval never|on-request] [--sandbox MODE] [--provider PROVIDER] [--model MODEL] [--effort minimal|low|medium|high|xhigh|max|ultra]
  chub list
  chub get <name|id>
