...
| [Claude Runtime generation](claude-runtime-generation.md) | Exact managed generation, install, activation, rollback, and preview host boundary |
| [Claude Runtime certification](claude-runtime-certification.md) | Shared conformance, real smoke, four-platform result contract, and production gates |
