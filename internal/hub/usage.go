...
func buildAgentUsageRange(agent AgentView, start, endExclusive, now time.Time) AgentUsage {
	...
	cacheKey := runtimeRef + "\x00" + strconv.Itoa(days) + "\x00" + start.Format("2006-01-02") + "\x00" + endExclusive.Format("2006-01-02") + "\x00" + now.Location().String() + "\x00" + publicProviderID(agent.ProviderID) + "\x00" + historyVersion
